...
app.get('/api/admins', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = `
...
app.delete('/api/admins/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
app.post('/api/admins', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id_pers } = req.body;
    try {
        const query = 'INSERT INTO t_admin (id_pers) VALUES ($1)';
        yield pool.query(query, [id_pers]);
...
app.post('/api/teams', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield pool.query(query, [id_team, team]);
...
app.get('/api/subject-types', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.post('/api/subject-types', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { type } = req.body;
    try {
        if (!type) {
        ...
        const result = yield pool.query(query, [type]);
...
app.put('/api/subject-types/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { type } = req.body;
    try {
        if (!type) {
        ...
        yield pool.query(query, [type, id]);
...
app.put('/api/subject-types/:id/color', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        ...
        yield pool.query(query, [color, id]);
...
app.delete('/api/subject-types/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
app.delete('/api/subjects/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
app.put('/api/subjects/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
app.post('/api/subjects', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { subject, id_subject_type } = req.body;
    try {
        if (!subject) {
        ...
        const result = yield pool.query(query, [subject, id_subject_type]);
...
app.post('/api/updateComment', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        const checkResult = yield pool.query(checkQuery, [id_pers, id_subject]);
        if (checkResult.rows.length > 0) {
      ...
      `;
            yield pool.query(updateQuery, [comment, id_pers, id_subject]);
        ...
        VALUES ($1, $2, $3)
      `;
            yield pool.query(insertQuery, [id_pers, id_subject, comment]);
...
app.get('/api/is-admin', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
app.get('/api/team-managers', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = `
      SELECT
        p.id_pers,
...
app.get('/api/teams-with-managers', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = `
      SELECT
        t.id_team,
...
app.get('/api/team-members', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = `
      SELECT
        p.id_pers,
...
app.put('/api/team-members/update', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield pool.query(query, [id_team, id_pers]);
...
app.post('/api/team-members/create', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (id_pers) {
            ...
            const checkResult = yield pool.query(checkQuery, [id_pers]);
            if (checkResult.rows.length > 0) {
                return res.status(400).json({ error: 'ID already exists' });
            }
            const query = 'INSERT INTO t_pers (id_pers, name, firstname, id_team) VALUES ($1, $2, $3, $4) RETURNING id_pers';
            const result = yield pool.query(query, [id_pers, name, firstname, id_team]);
            ...
            const result = yield pool.query(query, [name, firstname, id_team]);
            res.json({ id_pers: result.rows[0].id_pers, message: 'Team member added successfully' });
        }
    }
    catch (error) {
...
app.put('/api/team-members/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { id_team } = req.body;
    try {
        const query = 'UPDATE t_pers SET id_team = $1 WHERE id_pers = $2';
        yield pool.query(query, [id_team, id]);
        res.json({ message: 'Team member updated successfully' });
    }
    catch (error) {
        console.error(error);
...
app.delete('/api/team-members/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        // First, remove entries from t_teams_managers where id_pers matches
        yield pool.query('DELETE FROM t_teams_managers WHERE id_pers = $1', [id]);
        // Then, remove entries from t_pdc where id_pers matches
        yield pool.query('DELETE FROM t_pdc WHERE id_pers = $1', [id]);
        // Finally, delete the team member from t_pers
        yield pool.query('DELETE FROM t_pers WHERE id_pers = $1', [id]);
...
app.delete('/api/teams/:teamId/managers/:managerId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { teamId, managerId } = req.params;
    try {
        const query = 'DELETE FROM t_teams_managers WHERE id_team = $1 AND id_pers = $2';
        yield pool.query(query, [teamId, managerId]);
...
app.post('/api/teams/:teamId/managers', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/api/addLine', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const personResult = yield pool.query(personQuery, [name, firstname]);
        ...
        const subjectResult = yield pool.query(subjectQuery, [subject]);
      ...
      WHERE id_pers = $1 AND id_subject = $2 AND month = $3
    `;
        const checkResult = yield pool.query(checkQuery, [id_pers, id_subject, currentMonth]);
        if (checkResult.rows.length > 0) {
      ...
      `;
            const dataResult = yield pool.query(dataQuery, [id_pers, id_subject, currentMonth]);
      ...
      `;
            ...
            try {
                yield pool.query('SELECT id_team FROM t_pdc LIMIT 1');
                insertQuery = `
        ...
        `;
            ...
            const insertResult = yield pool.query(insertQuery, insertValues);
...
// API endpoint to add a new line
app.post('/api/addNewLine', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id_pers, id_subject } = req.body;
    try {
        const currentDate = new Date();
        // Construire YYYYMM comme nombre
        const currentMonth = Number(`${currentDate.getFullYear()}${(currentDate.getMonth() + 1)
            .toString()
            .padStart(2, '0')}`);
        // Check if the record already exists
        const checkQuery = `
...
app.get('/api/is-manager', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(' ')[1];
    if (!token) {
        return res.status(401).json({ error: 'Unauthorized' });
...
app.get('/api/related-persons', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        const result = yield pool.query(query, [id_pers]);
        res.json(result.rows);
    }
    catch (error) {
        console.error(error);
...
app.get('/api/color-mapping', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.put('/api/color-mapping/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        ...
        yield pool.query(query, [color_hex, id]);
...
app.post('/api/color-mapping', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield pool.query(query, [id_map, color_hex]);
...
app.delete('/api/color-mapping/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
